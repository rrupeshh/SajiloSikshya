        ...
        <div class="ss-article ss-card-8">
            ...
            <div class="ss-article-content">
                ...
                <div class="ss-container ss-card-4" style="margin-bottom: 10px;">
                    ...
                    <a style="margin-right: 10px;text-decoration: none;float: right;color: #39f;border-left: 5px solid #39f;font-style:italic;padding-left: 10px;" href="edit_delete_news_func.php?id=<?php echo $row1['news_id']?>&function=edit">Edit...</a>
                    <a style="margin-right: 10px;text-decoration: none;float: right;color: #39f;border-left: 5px solid #39f;font-style:italic;padding-left: 10px;" href="edit_delete_news_func.php?id=<?php echo $row1['news_id']?>&function=delete" onclick="return confirm('Are you sure want to delete this news?');">Delete...</a>
